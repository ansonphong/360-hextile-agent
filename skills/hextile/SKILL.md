---
name: hextile
description: "Drive 360 Hextile workflows from an AI coding agent. Use when generating 360° panoramas, listing workflow templates, overriding prompts, running dry_run validation, generating 360-LoRA seeds, or polling/cancelling renders via the local app API."
---
